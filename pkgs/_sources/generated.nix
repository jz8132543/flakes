...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  swagger-ui = {
    pname = "swagger-ui";
    version = "671b0f5f34bb42cc85a45fd69f30fd08bcff5e93";
    src = fetchurl {
  ...
  tuic = {
    pname = "tuic";
    version = "2f275ac50375385e97fb7666f5b5e071c302cda6";
    src = fetchFromGitHub {
      owner = "EAimTY";
      repo = "tuic";
      rev = "2f275ac50375385e97fb7666f5b5e071c302cda6";
      fetchSubmodules = false;
      sha256 = "sha256-t2cAw9VqgzwMIZJS8YnUlDaCoo4ofDX0yosv3AT1J2A=";
    };
    date = "2023-06-08";
  };
}
