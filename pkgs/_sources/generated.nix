...
}:
{
  ...
  realm = {
    pname = "realm";
    version = "ea48f4335065eebded263af82889941c39c8b424";
    src = fetchFromGitHub {
      owner = "zhboner";
      repo = "realm";
      rev = "ea48f4335065eebded263af82889941c39c8b424";
      fetchSubmodules = false;
      sha256 = "sha256-kvlKTtQ43o2hE5ihu4BnoDu4rjymORttLN71xCYolF4=";
    };
    date = "2026-01-12";
  };
  ...
  trackerslist = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-Q1CYu1iLu0Vws2FpAHAQnKtMrziNYV0UdJ+dsrVPw2k=";
    };
  };
}
