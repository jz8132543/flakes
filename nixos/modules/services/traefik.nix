...
with lib;
{
  ...
  config = {
    ...
    systemd.services.traefik-certs-dumper = {
      ...
      serviceConfig =
        let
          traefikServiceConfig = config.systemd.services.traefik.serviceConfig or { };
          user = traefikServiceConfig.User or "traefik";
          group = traefikServiceConfig.Group or "traefik";
